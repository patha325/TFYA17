function conductance =Eqsolv15(E,step)
...
v=0.3*tanh(0.1*((intervalstart/step:intervallength/step-1)-2/step))-0.4*tanh(0.1*((intervalstart/step:intervallength/step-1)-4/step));
