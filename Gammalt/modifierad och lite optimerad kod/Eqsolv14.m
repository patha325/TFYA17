function conductance =Eqsolv14(testvalue,step)
...
v=0.1*tanh(0.01*((intervalstart/step:intervallength/step-1)-2/step))-(testvalue + 0.5)*tanh(0.01*((intervalstart/step:intervallength/step-1)-4/step));
